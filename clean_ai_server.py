...
Спросите меня о чем угодно!"""
        ...
        # ПРИВЕТСТВИЕ
        if any(word in question for word in ['привет', 'здравств', 'hello', 'hi']):
            return "👋 Привет! Я ИИ-помощник. Спросите меня о новостях Узбекистана или решении примеров!"
...
if __name__ == '__main__':
    ...
    print("🚀 Чистый ИИ-сервер запущен на порту 5050...")
