...
# Красивый HTML с улучшенным дизайном
html_content = """
<!DOCTYPE html>
<html lang="ru">
<head>
...
<body>
    <div class="container">
        ...
        <div class="stats">
            ...
            <div class="stat-item">
                <div class="stat-number" id="cpu">0%</div>
        ...
        <div class="dashboard">
            <div class="card">
                ...
                <div class="card-value status-online" id="systemStatus">ONLINE</div>
                <div class="card-desc">Все системы работают</div>
            </div>
            
            <div class="card">
                <div class="card-icon">🚀</div>
                <h3 class="card-title">Производительность</h3>
                <div class="card-value" id="performance">100%</div>
                <div class="card-desc">Оптимальная нагрузка</div>
            </div>
            
            <div class="card">
                <div class="card-icon">🛡️</div>
                <h3 class="card-title">Безопасность</h3>
                <div class="card-value" id="security">ACTIVE</div>
                <div class="card-desc">Все защиты включены</div>
            </div>
            
            <div class="card">
                <div class="card-icon">🤖</div>
                <h3 class="card-title">Telegram бот</h3>
                <div class="card-value status-online" id="botStatus">ONLINE</div>
                <div class="card-desc">@RuslanOmegaBot</div>
            </div>
            
            <div class="card">
                <div class="card-icon">💾</div>
                <h3 class="card-title">Память</h3>
                <div class="card-value" id="memUsage">0 MB</div>
                <div class="card-desc">Использование</div>
            </div>
            
            <div class="card">
                <div class="card-icon">⏱️</div>
                <h3 class="card-title">Время ответа</h3>
                <div class="card-value" id="responseTime">0ms</div>
                <div class="card-desc">Среднее</div>
            </div>
        </div>
    ...
    <script>
        ...
        async function loadData() {
            try {
                ...
                const memoryUsage = Math.round(psutil ? psutil.virtual_memory().percent : 25);
                document.getElementById('memory').textContent = `${memoryUsage}%`;
                document.getElementById('memUsage').textContent = `${memoryUsage}%`;
